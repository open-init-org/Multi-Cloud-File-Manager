...
import org.openinit.multicloudfilemanager.AppShortcutsHelper;
import org.openinit.multicloudfilemanager.BuildConfig;
import org.openinit.multicloudfilemanager.Database.json.Importer;
import org.openinit.multicloudfilemanager.Database.json.SharedPreferencesBackup;
...
import org.openinit.multicloudfilemanager.Fragments.FileExplorerFragment;
import org.openinit.multicloudfilemanager.Fragments.LogFragment;
import org.openinit.multicloudfilemanager.Fragments.PermissionFragment;
import org.openinit.multicloudfilemanager.Fragments.RemotesFragment;
import org.openinit.multicloudfilemanager.Fragments.TasksFragment;
import org.openinit.multicloudfilemanager.Fragments.TriggerFragment;
...
import org.openinit.multicloudfilemanager.RemoteConfig.RemoteConfigHelper;
import org.openinit.multicloudfilemanager.RuntimeConfiguration;
...
import org.openinit.multicloudfilemanager.util.SharedPreferencesUtil;
import org.openinit.multicloudfilemanager.extract.updates.UpdateChecker;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bottomNavigationView != null) {
            bottomNavigationView.setOnItemSelectedListener(item -> onNavigationItemSelected(item));
        }
    ...
    protected void onResume() {
        super.onResume();
        BiometricLockManager.checkAndPromptLock(this);
        updatePermissionFragmentVisibility();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (bottomNavigationView != null && (id == R.id.nav_remotes || id == R.id.nav_tasks || id == R.id.nav_trigger || id == R.id.nav_logs)) {
            MenuItem bottomItem = bottomNavigationView.getMenu().findItem(id);
            if (bottomItem != null) {
