...
import org.openinit.multicloudfilemanager.util.Rfc3339Deserializer;
...
public class RcloneRcd {
    ...
    /**
     * Less memory overhead than {@link org.openinit.multicloudfilemanager.Items.FileItem} by removing pregenerated formatting
     */
    @JsonIgnoreProperties(ignoreUnknown = true)
