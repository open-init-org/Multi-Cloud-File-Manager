...
import org.openinit.multicloudfilemanager.extract.settings.language.LanguagePicker
import org.openinit.multicloudfilemanager.extract.settings.preferences.FilesizePreference
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        biometricPreference?.setOnPreferenceChangeListener { preference, newValue ->
            ...
            if (enable) {
                ...
                if (!org.openinit.multicloudfilemanager.util.BiometricLockManager.canAuthenticate(context)) {
                    Toast.makeText(
                        context,
                    ...
                    org.openinit.multicloudfilemanager.util.BiometricLockManager.promptBiometric(
                        activity,
                        onSuccess = {
