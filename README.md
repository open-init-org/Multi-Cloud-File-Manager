...
|:-----------------------------------------------------------------------------------------------------------------------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------:|
| <img src="docs/cloud-computing.png" alt="Cloud Access" width="144" />  | <img src="docs/locked-padlock.png" alt="256 Bit End-to-End Encryption" width="108" /> | <img src="docs/smartphone.png" alt="Integrated Experience" width="132"/> |
...
## Libraries
- [rclone](https://github.com/rclone/rclone) - Calling this a library is an understatement. Without rclone, there would not be Multi Cloud File Manager. See https://rclone.org/donate/ to support rclone.
